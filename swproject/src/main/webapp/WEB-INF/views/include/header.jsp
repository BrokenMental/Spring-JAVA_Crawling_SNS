                    ...
                    <a href="#">View all tasks</a>
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="/resources/dist/img/user0.png" class="user-image"
								alt="User Image" /> <span class="hidden-xs"></span>
						</a>
							<ul class="dropdown-menu">
								<!-- User image -->
								<li class="user-header"><img
									src="/resources/dist/img/user0.png" class="img-circle"
									alt="User Image" />
									<p>
										Jinuk HA - Inha TC Student <small>Member since Nov.
											2012</small>
									</p></li>
								<!-- Menu Body -->
								<!--                   <li class="user-body">
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					<div class="pull-left image">
						<img src="/resources/dist/img/user0.png" class="img-circle"
							alt="User Image" />
					</div>
                ...
                <li><a href="../charts/inline.html"><i class="fa fa-circle-o"></i> Inline charts</a></li>
					...
					<li class="treeview active"><a href="#"> <i
						...
						<ul class="treeview-menu">
							...
							<li><a href="../../Crawl/CrawlList2"><i
									class="fa fa-circle-o"></i> Crawler Page2</a></li>
						</ul></li>
					<!--             <li class="treeview">
              <a href="#">
